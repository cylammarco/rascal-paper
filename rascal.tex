...
This article is organised as follow: in Section~\textsection2, we will address
the difficulties in achieving automated wavelength calibration; in Section~\textsection3,
\texttt{RASCAL} will describes in detail; the quality and the repeatability will
be demonstrated in Section~\textsection4; the deployment on various systems and some example
independent demonstrators will be reported in Section~\textsection5; in the final section, we
